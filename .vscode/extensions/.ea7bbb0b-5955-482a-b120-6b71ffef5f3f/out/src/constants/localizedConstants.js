...
exports.loadLocalizedConstants = (locale) => {
    ...
    exports.cannotConnect = localize(41, null);
    exports.aad = localize(42, null);
    exports.usernamePrompt = localize(43, null);
    exports.usernamePlaceholder = localize(44, null);
    exports.passwordPrompt = localize(45, null);
    exports.passwordPlaceholder = localize(46, null);
    exports.msgSavePassword = localize(47, null);
    exports.profileNamePrompt = localize(48, null);
    exports.profileNamePlaceholder = localize(49, null);
    exports.filepathPrompt = localize(50, null);
    exports.filepathMessage = localize(51, null);
    exports.overwritePrompt = localize(52, null);
    exports.overwritePlaceholder = localize(53, null);
    exports.msgCannotOpenContent = localize(54, null);
    exports.msgSaveStarted = localize(55, null);
    exports.msgSaveFailed = localize(56, null);
    exports.msgSaveSucceeded = localize(57, null);
    exports.msgSelectProfileToRemove = localize(58, null);
    exports.confirmRemoveProfilePrompt = localize(59, null);
    exports.msgNoProfilesSaved = localize(60, null);
    exports.msgProfileRemoved = localize(61, null);
    exports.msgProfileCreated = localize(62, null);
    exports.msgProfileCreatedAndConnected = localize(63, null);
    exports.msgClearedRecentConnections = localize(64, null);
    exports.msgIsRequired = localize(65, null);
    exports.msgError = localize(66, null);
    exports.msgYes = localize(67, null);
    exports.msgNo = localize(68, null);
    exports.defaultDatabaseLabel = localize(69, null);
    exports.notConnectedLabel = localize(70, null);
    exports.notConnectedTooltip = localize(71, null);
    exports.connectingLabel = localize(72, null);
    exports.connectingTooltip = localize(73, null);
    exports.connectErrorLabel = localize(74, null);
    exports.connectErrorTooltip = localize(75, null);
    exports.connectErrorCode = localize(76, null);
    exports.connectErrorMessage = localize(77, null);
    exports.cancelingQueryLabel = localize(78, null);
    exports.updatingIntelliSenseLabel = localize(79, null);
    exports.extensionNotInitializedError = localize(80, null);
    exports.untitledScheme = localize(81, null);
    exports.msgChangeLanguageMode = localize(82, null);
    exports.msgChangedDatabaseContext = localize(83, null);
    exports.msgPromptRetryCreateProfile = localize(84, null);
    exports.refreshTokenLabel = localize(85, null);
    exports.msgGetTokenFail = localize(86, null);
    exports.msgPromptRetryConnectionDifferentCredentials = localize(87, null);
    exports.msgPromptRetryFirewallRuleExtNotInstalled = localize(88, null);
    exports.msgPromptRetryFirewallRuleNotSignedIn = localize(89, null);
    exports.msgPromptRetryFirewallRuleSignedIn = localize(90, null);
    exports.msgPromptRetryFirewallRuleAdded = localize(91, null);
    exports.msgAccountRefreshFailed = localize(92, null);
    exports.msgUnableToExpand = localize(93, null);
    exports.msgPromptAzureExtensionActivatedNotSignedIn = localize(94, null);
    exports.msgPromptAzureExtensionActivatedSignedIn = localize(95, null);
    exports.msgPromptFirewallRuleCreated = localize(96, null);
    exports.msgAccountNotFound = localize(97, null);
    exports.msgChooseQueryHistory = localize(98, null);
    exports.msgChooseQueryHistoryAction = localize(99, null);
    exports.msgOpenQueryHistory = localize(100, null);
    exports.msgRunQueryHistory = localize(101, null);
    exports.msgInvalidIpAddress = localize(102, null);
    exports.msgNoQueriesAvailable = localize(103, null);
    exports.retryLabel = localize(104, null);
    exports.signInLabel = localize(105, null);
    exports.downloadAndInstallLabel = localize(106, null);
    exports.createFirewallRuleLabel = localize(107, null);
    exports.msgConnecting = localize(108, null);
    exports.msgConnectionNotFound = localize(109, null);
    exports.msgFoundPendingReconnect = localize(110, null);
    exports.msgPendingReconnectSuccess = localize(111, null);
    exports.msgFoundPendingReconnectFailed = localize(112, null);
    exports.msgFoundPendingReconnectError = localize(113, null);
    exports.msgAcessTokenExpired = localize(114, null);
    exports.msgRefreshTokenError = localize(115, null);
    exports.msgRefreshConnection = localize(116, null);
    exports.msgRefreshTokenSuccess = localize(117, null);
    exports.msgRefreshTokenNotNeeded = localize(118, null);
    exports.msgConnectedServerInfo = localize(119, null);
    exports.msgConnectionFailed = localize(120, null);
    exports.msgChangingDatabase = localize(121, null);
    exports.msgChangedDatabase = localize(122, null);
    exports.msgDisconnected = localize(123, null);
    exports.msgErrorReadingConfigFile = localize(124, null);
    exports.titleResultsPane = localize(125, null);
    exports.macOpenSslErrorMessage = localize(126, null);
    exports.macOpenSslHelpButton = localize(127, null);
    exports.macSierraRequiredErrorMessage = localize(128, null);
    exports.gettingDefinitionMessage = localize(129, null);
    exports.definitionRequestedStatus = localize(130, null);
    exports.definitionRequestCompletedStatus = localize(131, null);
    exports.updatingIntelliSenseStatus = localize(132, null);
    exports.intelliSenseUpdatedStatus = localize(133, null);
    exports.testLocalizationConstant = localize(134, null);
    exports.disconnectOptionLabel = localize(135, null);
    exports.disconnectOptionDescription = localize(136, null);
    exports.disconnectConfirmationMsg = localize(137, null);
    exports.elapsedBatchTime = localize(138, null);
    exports.noActiveEditorMsg = localize(139, null);
    exports.maximizeLabel = localize(140, null);
    exports.restoreLabel = localize(141, null);
    exports.saveCSVLabel = localize(142, null);
    exports.saveJSONLabel = localize(143, null);
    exports.saveExcelLabel = localize(144, null);
    exports.fileTypeCSVLabel = localize(145, null);
    exports.fileTypeJSONLabel = localize(146, null);
    exports.fileTypeExcelLabel = localize(147, null);
    exports.resultPaneLabel = localize(148, null);
    exports.selectAll = localize(149, null);
    exports.copyLabel = localize(150, null);
    exports.copyWithHeadersLabel = localize(151, null);
    exports.executeQueryLabel = localize(152, null);
    exports.messagePaneLabel = localize(153, null);
    exports.lineSelectorFormatted = localize(154, null);
    exports.elapsedTimeLabel = localize(155, null);
    exports.msgCannotSaveMultipleSelections = localize(156, null);
    exports.mssqlProviderName = localize(157, null);
    exports.noneProviderName = localize(158, null);
    exports.chooseSqlLang = localize(159, null);
    exports.flavorChooseLanguage = localize(160, null);
    exports.flavorDescriptionMssql = localize(161, null);
    exports.flavorDescriptionNone = localize(162, null);
    exports.queryOutputDocumentTitle = localize(163, null);
    exports.queryOutputHostTitle = localize(164, null);
    exports.msgAddConnection = localize(165, null);
    exports.msgConnect = localize(166, null);
    exports.azureSignIn = localize(167, null);
    exports.azureSignInDescription = localize(168, null);
    exports.azureSignInWithDeviceCode = localize(169, null);
    exports.azureSignInWithDeviceCodeDescription = localize(170, null);
    exports.azureSignInToAzureCloud = localize(171, null);
    exports.azureSignInToAzureCloudDescription = localize(172, null);
    exports.taskStatusWithName = localize(173, null);
    exports.taskStatusWithMessage = localize(174, null);
    exports.taskStatusWithNameAndMessage = localize(175, null);
    exports.failed = localize(176, null);
    exports.succeeded = localize(177, null);
    exports.succeededWithWarning = localize(178, null);
    exports.canceled = localize(179, null);
    exports.inProgress = localize(180, null);
    exports.canceling = localize(181, null);
    exports.notStarted = localize(182, null);
    exports.nodeErrorMessage = localize(183, null);
    exports.deleteCredentialError = localize(184, null);
    exports.msgClearedRecentConnectionsWithErrors = localize(185, null);
};
