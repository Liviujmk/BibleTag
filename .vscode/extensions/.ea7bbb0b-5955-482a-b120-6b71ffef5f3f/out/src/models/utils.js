...
exports.deepClone = exports.generateQueryUri = exports.limitStringSize = exports.getSignInQuickPickItems = exports.getCommonLaunchArgsAndCleanupOldLogFiles = exports.removeOldLogFiles = exports.getConfigLogRetentionSeconds = exports.getConfigLogFilesRemovalLimit = exports.getConfigTracingLevel = exports.parseNumAsTimeString = exports.isBoolean = exports.parseTimeString = exports.Timer = exports.isFileExisting = exports.isSameConnection = exports.isSameProfile = exports.isSameAccountKey = exports.formatString = exports.escapeClosingBrackets = exports.azureAuthTypeToString = exports.authTypeToString = exports.isNotEmpty = exports.isEmpty = exports.showErrorMsg = exports.showWarnMsg = exports.showInfoMsg = exports.logDebug = exports.logToOutputChannel = exports.getActiveTextEditorUri = exports.getActiveTextEditor = exports.isEditingSqlFile = exports.generateUserId = exports.generateGuid = exports.getPackageInfo = void 0;
